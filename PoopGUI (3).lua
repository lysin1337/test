...
ComingSoon.Size = UDim2.new(1, -40, 0, 60)
ComingSoon.Position = UDim2.new(0, 20, 0.4, -30)
ComingSoon.BackgroundTransparency = 1
ComingSoon.Text = "🚧  Yakında..."
ComingSoon.TextColor3 = Color3.fromRGB(100, 80, 130)
ComingSoon.TextSize = 20
ComingSoon.Font = Enum.Font.GothamBold
ComingSoon.Parent = CharPage
